...
requests_cache.install_cache(f'{HOME}/my_github_org_stats', expire_after=expire_after)
...
file_path = f"{HOME}/sync/tmp/my_github_org_stats_{GITHUB_ORG}_{GITHUB_USER}_{now}.log"
