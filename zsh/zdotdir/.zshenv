...
export IP_RANGE_PREFIX ; IP_RANGE_PREFIX='192.168.0.'
...
export DONE_FILE ; DONE_FILE="${HOME}/sync/todo-txt/done.txt"
export REPORT_FILE ; REPORT_FILE="${HOME}/sync/todo-txt/report.txt"
...
export TODO_FILE ; TODO_FILE="${HOME}/sync/todo-txt/todo.txt"
...
if which git &>/dev/null; then
    export GITHUB_ORG ; GITHUB_ORG=$(git config --file \
        "${HOME}/sync/git/.gitconfig.work" github.organization)
